...
/**
 * ClassName: ExpectedNumberStatistics
 * Description:
 ...
 */
public class ExpectedNumberStatistics {

    public static void main(String[] args) {
        int[] a = {1,2,3};
        ExpectedNumberStatistics expectedNumberStatistics = new ExpectedNumberStatistics();
        System.out.println(expectedNumberStatistics.expectNumber(a));
    }
